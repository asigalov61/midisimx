...
###################################################################################
#
#	midisimx Helpers Python Module
#	Version 1.0
#
#	Project Los Angeles
#
...
print('=' * 70)
print('Loading midisimx helpers module...')
print('Please wait...')
print('=' * 70)

__version__ = '1.0.0'

print('midisimx helpers module version', __version__)
print('=' * 70)
...
###################################################################################
# This is the end of the midisimx Helpers Python Module
###################################################################################